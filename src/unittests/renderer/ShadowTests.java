...
public class ShadowTests {
	...
	public void SphereTriangleInitial() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0), //
				 1, 1E-5, 1.5E-7, new Point3D(-100, 100, -200), new Vector(1, -1, 3)));
	...
	public void SphereTriangleMove1() {
		...
		scene.addGeometries(new Sphere( new Point3D(0, 0, 200),60,new Color(java.awt.Color.BLUE),
						new Material(0.5, 0.5, 30)), //
				new Triangle(new Color(java.awt.Color.BLUE), new Material(0.5, 0.5, 30), //
						new Point3D(-65, 30, 0), new Point3D(-35, 60, 0), new Point3D(-63, 58, 4)));
	...
	public void SphereTriangleSpot1() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0), //
				1, 1E-5, 1.5E-7, new Point3D(-90, 90, -170), new Vector(1, -1, 3)));
	...
	public void SphereTriangleSpot2() {
		...
		scene.addLights(new SpotLight(new Color(400, 240, 0), //
				1, 1E-5, 1.5E-7, new Point3D(-77, 75, -95), new Vector(1, -1, 3)));
	...
	public void trianglesSphere() {
		...
		scene.addGeometries( //
				...
				new Sphere(new Point3D(0, 0, 115),30,new Color(java.awt.Color.BLUE),
						new Material(0.5, 0.5, 30)));

		scene.addLights(new SpotLight(new Color(700, 400, 400), //
				1, 4E-4, 2E-5,new Point3D(40, -40, -115), new Vector(-1, 1, 4)));
