...
public class ReflectionRefractionTests {
	...
	public void twoSpheresOnMirrors() {
		...
		scene.addGeometries(
				new Sphere(new Point3D(-950, 900, 1000),400,new Color(0, 0, 100), new Material(0.25, 0.25, 20, 0.5, 0)),
		...
		scene.addLights(new SpotLight(new Color(1020, 400, 400), 1, 0.00001, 0.000005,  new Point3D(-750, 750, 150),
				   new Vector(-1, 1, 4)));

		ImageWriter imageWriter = new ImageWriter("twoSpheresMirrored", 2500, 2500, 500, 500);
		Render render = new Render(imageWriter, scene,50,8);
	...
	public void trianglesTransparentSphere() {
		...
		scene.addGeometries( //
				...
				new Sphere( new Point3D(60, -50, 50),30,
						new Color(java.awt.Color.BLUE), new Material(0.2, 0.2, 30, 0.6, 0)));

		scene.addLights(new SpotLight(new Color(700, 400, 400),1, 4E-5, 2E-7,
